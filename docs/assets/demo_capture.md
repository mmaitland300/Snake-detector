...
- Public Hugging Face app is live at `https://mmaitland-snake-detector-demo.hf.space`.
- The live Space uses the real-photo Keras model documented in `docs/releases/v1.1.0-real-dataset.md`.
...
- Automated screenshot capture is still pending because local headless Chrome previously failed with a Crashpad access-denied error in this workspace.
